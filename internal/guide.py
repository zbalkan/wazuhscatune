...
class Guide:
    ...
    def export_loosening(self, loosening_path: str) -> None:
        ...
        with open(file=md_path, mode='w') as fs:
            ...
            fs.write("\n## Notes\n\n")
            fs.write("The markdown is generated by `wazuhscatune` tool. Try to avoid manual changes. If manual change is needed, update loosening YML and and custom SCA file as well.\n")
