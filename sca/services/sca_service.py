...
from sca.internal.sca import Check, Compliance, SCA
...
class SCAService:
    ...
    @staticmethod
    def _serialize_compliance(compliance: list[Compliance]) -> list[Compliance]:
        return [dict(item) for item in compliance]
